    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tax_rate_ref', models.CharField(blank=True, help_text='QuickBooks TaxRateRef value', max_length=50, null=True)),
                ('tax_percent', models.DecimalField(decimal_places=2, default=0, help_text='Actual tax percentage', max_digits=5)),
                ...
                ('customer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='invoices', to='customers.customer')),
            ],
        ),
        migrations.CreateModel(
            name='InvoiceLine',
            fields=[
                ...
                ('tax_code_ref', models.CharField(blank=True, help_text='QuickBooks TaxCodeRef value', max_length=50, null=True)),
                ('tax_rate_ref', models.CharField(blank=True, help_text='QuickBooks TaxRateRef value', max_length=50, null=True)),
                ('tax_percent', models.DecimalField(decimal_places=2, default=0, help_text='Actual tax percentage', max_digits=5)),
