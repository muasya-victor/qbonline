    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tax_rate_ref', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('related_invoice', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='credit_notes', to='invoices.invoice')),
            ],
        ),
        migrations.CreateModel(
            name='CreditNoteLine',
